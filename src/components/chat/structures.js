...
const genericMessage = ({ source, text, input_type = "message" }) => {
...
export const formMessage = (text, input_name) => {return genericMessage({})};
export const userMessage = text =>
  genericMessage({ source: "user", text: text });
export const botMessage = text => {return genericMessage({source:'bot', text:text})}
